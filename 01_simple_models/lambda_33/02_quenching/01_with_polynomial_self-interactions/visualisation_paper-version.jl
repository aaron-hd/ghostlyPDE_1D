...
#             maximum(abs.(hamiltonianTab[end][1:Nt])),
    ...
    energiesPlot = plot(
        layout=(1), framestyle=:box, dpi = 400, size = (300,350), 
        legend=:topleft,
        guidefont = "Computer Modern", tickfont = "Computer Modern",
        xguidefontsize = 16, yguidefontsize = 16, 
        legendfontsize = 12, titlefontsize = 16, tickfontsize = 12,
...
#     chiField = [sol[:, i][j] - offsetchi for i = 1:Nt, j=2N+1:3N];
    ...
    rangePhi = 5.5#maximum((maximum(abs.(phiField)),2.1))/2;
    rangeChi = 5.5#maximum((maximum(abs.(chiField)),2.1))/2;
...
#     rangeChi = minimum((maximum(abs.(chiField[1:div(Nt, 2),:])),3.5));
    ...
    densityplot = plot(
        layout=(1), size = (300,350), framestyle=:box, dpi = 400, 
        guidefont = "Computer Modern", tickfont = "Computer Modern",
        xguidefontsize = 16, yguidefontsize = 16, 
        legendfontsize = 12, titlefontsize = 16, tickfontsize = 12,
