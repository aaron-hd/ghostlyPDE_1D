...
#             maximum(abs.(hamiltonianTab[end][1:Nt] - hamPhiTab[end][1:Nt] - hamChiTab[end][1:Nt]))
    ...
    energiesPlot = plot(
        layout=(1), framestyle=:box, dpi = 400, size = (350,350), 
        legend=:topleft,
...
#     chiField = [sol[:, i][j] - offsetchi for i = 1:Nt, j=2N+1:3N];
    ...
    rangePhi = maximum((maximum(abs.(phiField)),2.1))/2;
    rangeChi = maximum((maximum(abs.(chiField)),2.1))/2;
...
#     rangeChi = minimum((maximum(abs.(chiField[1:div(Nt, 2),:])),3.5));
    ...
    densityplot = plot(
        layout=(1), size = (400,600), framestyle=:box, dpi = 300, 
        guidefont = "Computer Modern", tickfont = "Computer Modern",
        xguidefontsize = 16, yguidefontsize = 16, 
        legendfontsize = 16, titlefontsize = 16, tickfontsize = 16,
    ...
    densityplot = plot(
        layout=(1), size = (500,600), framestyle=:box, dpi = 300, 
        guidefont = "Computer Modern", tickfont = "Computer Modern",
        xguidefontsize = 16, yguidefontsize = 16, 
        legendfontsize = 16, titlefontsize = 16, tickfontsize = 16,
